...
<!--                </div>-->
                ...
                <?php if ( $loop->have_posts() ) : ?>
                    <div class="bonuses bonus-margin">
                        <h5>Bonuses</h5>
                ...
                <?php endif; ?>
                <?php wp_reset_query(); ?>
                <?php if(get_field('betting-advice-bet')) : ?>
                    <div class="bonuses bonus-margin">
                        <h5>Betting advice</h5>
                        <div class="bonus-grid summation">
                            <div class="bonus-logo">
                               <strong>Bet:</strong>
                            </div>
                            <span><?php echo the_field('betting-advice-bet') ; ?></span>
                        </div>
                        <div class="bonus-grid summation">
                            <div class="bonus-logo">
                                <strong>Odds:</strong>
                            </div>
                            <span><?php the_field('betting-advice-odds') ; ?></span>
                        </div>
                        <div class="bonus-grid summation">
                            <a target="_blank" href="<?php the_field('betting-advice-company-link') ; ?>" class="absolute-link"></a>
                            <div class="bonus-logo">
                                <strong>Company:</strong>
                            </div>
                            <p><?php the_field('betting-advice-company') ; ?></p>
                        </div>
                        <div class="bonus-grid summation">
                            <div class="bonus-logo">
                                <strong>Match starts:</strong>
                            </div>
                        ...
                        <div class="bonus-grid summation">
                            ...
                            <p><?php the_field('betting-advice-stream') ; ?></p>
                        </div>
                    </div>
                <?php endif ; ?>
                <?php the_field('match-poll') ; ?>
